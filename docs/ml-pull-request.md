...
Opening a pull request will trigger a[workflow](../.github/workflows/mlopsllm-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-5565834108644774.14.azuredatabricks.net/explore/data/models/staging/mlopsllm/mlopsllm-model)
* [Prod model in UC](https://adb-6698555481828834.14.azuredatabricks.net/explore/data/models/prod/mlopsllm/mlopsllm-model)
. 
