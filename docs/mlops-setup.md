...
git add README.md docs .gitignore mlopsllm/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. Verify that you're an admin by viewing the
  [staging workspace admin console](https://adb-5565834108644774.14.azuredatabricks.net#setting/accounts) and
  [prod workspace admin console](https://adb-6698555481828834.14.azuredatabricks.net#setting/accounts). If
...
If you want to use different catalog names, please update the target names declared in the[mlopsllm/databricks.yml](../mlopsllm/databricks.yml) file.
...
Follow the instructions in [mlopsllm/resources/README.md](../mlopsllm/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../mlopsllm/resources/README.md)  to propose, test, and deploy
